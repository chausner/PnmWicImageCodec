...
extern const GUID CLSID_PnmContainer;

extern const GUID CLSID_PnmDecoder;

class PnmDecoder : public UnknownImpl<IWICBitmapDecoder>
{
public:
    // IUnknown Interface
...
private:
    std::vector<ComPtr<PnmFrameDecode> > frames;   
};
